...
const CountDownClock = () => {
  return (
      <div
        ...
        data-wow-delay="0.7s"
      >
        <h2 style={{fontSize: "2rem"}} class="text-white text-center">Pre Sale Ends in</h2>
        <div
          id="clock3"
        ...
        <div class="current-bonus-area text-white d-flex flex-wrap justify-content-between pb-10">
          ...
          <div class="current-bonus">
            ...
            <div style={{display:"flex", jusitfyContents: "space-evenly", alignItems: "center", marginTop: "0.1rem"}}>
                    <img style={{ width: "1rem", marginRight:"0.5rem"}} alt="eth icon" src={eth} />
