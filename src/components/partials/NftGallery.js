        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-6 mobile-pb-10 invented-cont">
            ...
            >
              <h2 style={{ color: "white" }}>
                Rock your Keychain Anywhere, Anyhow, and Everywhere.{" "}
              </h2>
              <p style={{ color: "lightgray" }}>
                Introducing the Artifact Keychain, the world's first NFT
                keychain & the perfect way to display your NFT's.
              </p>
            </div>
          </div>
          <div class="col-12 col-md-6 col-lg-6">
            <div class="row">
              ...
              <div
                class="pbl-col col-12 col-md-12 col-lg-6 pb-30 wow zoomIn"
                data-wow-duration="1s"
                data-wow-delay=".4s"
              >
